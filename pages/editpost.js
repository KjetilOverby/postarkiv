...
const editpost = ({startRingsPostOppsett, rawRingsPostOppsett, endRingsPostOppsett, bladstamme, headerPostOppsett, getIDforDe, getIdForEdit}) => {
    ...
    const [bladeDimension, setBladeDimension] = useState({ bladStamme: bladstamme });
