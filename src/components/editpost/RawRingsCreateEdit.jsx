...
import RingComponent from "../common/create/middlesection/RingComponent";
import { RiDeleteBin6Line } from "react-icons/ri";
import { MdAddCircle } from "react-icons/md";
import ShimsRingList from "../common/create/middlesection/ShimsRingList";

const RawRingsCreateEdit = ({
  rawButtonValue,
  rawRingsCollection,
  ...
  const antallPlank = rawRingsCollection && rawRingsCollection.length;
...
export default RawRingsCreateEdit;
